package com.sun.rooster.util.redisUtils;
...
public class RedissonHandler {
    ...
    private final String port = env.getProperty("redis.port");

    private final String ip = env.getProperty("redis.ip");

    private final String password = env.getProperty("redis.password");
...
//        RedissonHandler.getInstance().delete("user");
        String  u2 = RedissonHandler.getInstance().get("sunshibo");
