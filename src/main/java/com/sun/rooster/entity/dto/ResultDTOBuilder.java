package com.sun.rooster.entity.dto;

import com.sun.rooster.util.StringUtils;
import com.sun.rooster.util.env.Env;
...
public class ResultDTOBuilder {
    ...
    public static ResultDTO failure(String errCode , Exception e) {
        Env env = new Env();
        ResultDTO<String> instance = getInstance(errCode,
                StringUtils.clearNull(env.getProperty(errCode)) + "/Exception:" + e.getMessage(), false, "");
        return instance;
    }
